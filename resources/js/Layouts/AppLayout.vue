<template>
    <div class="min-h-screen bg-gray-100">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('archive')" :active="route().current('archive')">
                                Архив
                            </jet-nav-link>
                            <jet-nav-link :href="route('archive')" :active="route().current('archive')">
                                Мои задачи
        ...
        <notifications class="b-notifications"></notifications>
    </div>
</template>
...
<script>
    ...
    import Notifications from "@/Jetstream/Notifications";
